...
/// Encrypted file containing a key share for a wallet
#[derive(Debug, Serialize, Deserialize)]
pub struct KeystoreFile<C: Ciphersuite> {
    ...
    /// Which device this belongs to
    pub device_id: String,
    
    /// Device's key share
    #[serde(bound(serialize = "frost_core::keys::KeyPackage<C>: Serialize"))]
    #[serde(bound(deserialize = "frost_core::keys::KeyPackage<C>: for<'a> Deserialize<'a>"))]
    pub key_package: frost_core::keys::KeyPackage<C>,
    
    /// Maps peer IDs to identifiers
    #[serde(bound(serialize = "Identifier<C>: Serialize"))]
    #[serde(bound(deserialize = "Identifier<C>: for<'a> Deserialize<'a>"))]
    pub identifier_map: BTreeMap<String, Identifier<C>>,
    
    /// When this keystore was created
    pub created_at: u64,
    
    /// When this keystore was last modified
...
impl<C: Ciphersuite> KeystoreFile<C> {
